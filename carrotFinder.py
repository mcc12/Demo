...
class image_converter:
    ...
    def img_callback(self, data):
        ...
        #for every component in the image, keep if it's above min_size and below max_size
        #basic attempt to find weeds taking advantage of the repeated assets in simulator   
    ...
    def getDisplacement(self, imageX, imageY):
        ...
        #Naive implementation taking advantage of flat ground plane and known distances
        #at the cameras distance returned image is practically orthographic
